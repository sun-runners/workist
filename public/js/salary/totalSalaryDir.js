			...
			link : function(scope, element, attrs){
          		function initialize() {
					...
					scope.getPercentage = (memberId) => {
						...
						let prevMonthsDates = totalSalaryS.prevMonthsDate(allDatesToNow, $rootScope.dt.month - 1); /** we get all the dates from jan 1 to last Day of last month */
						...
						// return "new Date : " + new Date().getMonth() + " " + ($rootScope.dt.month - 1)
					}

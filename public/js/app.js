angular.module('workingHoursTrello', [
  ...
  async function initApi() {
    ...
    $rootScope.calendarLists = await apiS.calendarBoardLists(key, token).then(res => res.data)
    $rootScope.calendarCards = await  apiS.calendarBoardCards(key, token).then(res => res.data)
